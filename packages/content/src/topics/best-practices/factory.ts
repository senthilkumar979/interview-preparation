...
import { bestPracticesLevels } from "./levels";

export interface BestPracticesTopicDraft {
  slug: string;
  title: string;
  order: number;
  summary: string;
...
export function bestPracticesTopic(draft: BestPracticesTopicDraft): Topic {
  return {
    slug: draft.slug,
    title: draft.title,
    technologySlug: "best-practices",
    module: "Best practices",
    order: draft.order,
    summary: draft.summary,
    prerequisites: draft.prerequisites ?? [],
    related: draft.related ?? [],
    levels: bestPracticesLevels,
