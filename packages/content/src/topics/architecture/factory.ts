...
import { architectureLevels } from "./levels";

export interface ArchitectureTopicDraft {
  slug: string;
  title: string;
  order: number;
  summary: string;
...
export function architectureTopic(draft: ArchitectureTopicDraft): Topic {
  return {
    slug: draft.slug,
    title: draft.title,
    technologySlug: "architecture",
    module: "Architecture",
    order: draft.order,
    summary: draft.summary,
    prerequisites: draft.prerequisites ?? [],
    related: draft.related ?? [],
    levels: architectureLevels,
